...
El código fuente del proyecto \software{DL\_Bayesian} está disponible como repositorio de código abierto:

\begin{center}
\url{https://github.com/alujan/DL_Bayesian}
\end{center}

El repositorio incluye notebooks demostrativos, documentación técnica completa, y datos de ejemplo para reproducibilidad.
